return {
  ...
  -- LSP/Formatting Engine
  {
    ...
    config = function()
      ...
      local format_and_code_action = function()
        vim.lsp.buf.format({ async = false })
        -- vim.lsp.buf.code_action(vim.lsp.util.make_range_params())
      ...
      vim.keymap.set(
        "n",
        "<leader>bf",
        format_and_code_action,
        { desc = "Format buffer and fix all diagnostics" }
      )
