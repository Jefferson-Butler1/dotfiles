--most of this is just copy and pasted from the internet with some mods done by claude.
return {
	...
	config = function()
		require("gitsigns").setup({
			...
			on_attach = function(bufnr)
				...
				-- @edit the keybinds kinda suck. I'd definitely look through and see which ones you want to keep, but i would suggest nuking/rebinding 99%
				-- Navigation
				map("n", "]c", function()
					if vim.wo.diff then
						return "]c"
